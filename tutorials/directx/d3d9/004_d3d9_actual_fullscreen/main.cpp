/*
    ...
    Direct3D9 Actual Fullscreen application
 */
...
static bool init_window( d3dApp &app ) {
    ...
    const GLFWvidmode *primary_monitor_mode = glfwGetVideoMode( glfwGetPrimaryMonitor() );
...
static bool init_d3d9( d3dApp &app ) {
    ...
    app.d3d9.d3dpp.BackBufferWidth        = d3ddm.Width;
    app.d3d9.d3dpp.BackBufferHeight       = d3ddm.Height;
    ...
    app.d3d9.d3dpp.FullScreen_RefreshRateInHz = d3ddm.RefreshRate;
